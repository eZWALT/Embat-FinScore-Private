...
| `persistent-memory/2026-09-20-0808-speak-reason-points.md` | Overnight: reason `points` is spoken `−8,6`, not raw `-8.55`. |
...
| `persistent-memory/2026-09-20-0832-evidence-chart-list-es.md` | Overnight: leftover alert evidence is a spoken tenth; missing charts list `disponibles`. |
