...
1. Entidad: si nombran Empresa/Grupo o `COMP_*` / `GROUP_*`, esa. Si nombran un color, el mapa `series` de SESSION. Si el gráfico ya lista empresas, habla de esas. Si no hay ninguna, una línea: ¿cuál?
