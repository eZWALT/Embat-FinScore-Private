...
- Periodo / varias empresas: **1 línea** de hallazgo + **1 viñeta por empresa** (índice, Δ, €). Máximo 4 viñetas. Sin párrafo extra. Cuenta los `guard`: «sin tope» no es entradas hundidas. Mora de cobros no es «falta de entradas». «deteriorando» no es «se mueve poco». Dueño solo si `get_alerts` lo trajo.
